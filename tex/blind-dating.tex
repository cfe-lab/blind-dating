...
\author[addressref={1,2,3},email={apoon@cfenet.ubc.ca},corref={3}]{Art F.Y. Poon} % apoon@cfenet.ubc.ca
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=10cm]{patient_16617}
	\caption{%
