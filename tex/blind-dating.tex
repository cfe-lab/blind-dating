...
Thus, if the frequency of censored lineages who are sampled later than the linear model predicts is significantly greater than 0.5, then we expect that some of the censored lineages have undergone at least some latency.
...
This is consistent with the potent reduction in HIV replication under HAART, which servers to increase the ratio of latent to actively-infected cells by reducing the latter.
...
\begin{figure}[p]
	...
	{Reconstructing the time that a viral lineage entered a latent state from with-host sequence variation.}
