...
For each patient, we fit the linear model (LM) of \label{eq:glm} to the RNA sequences of \label{eq:}
...
To validate our model, we restricted our Patient R1 data set to the training RNA sequences, which are the plasma-derived RNA squences sampled while the patient was not on therapy.
...
Almost all of the LM fits were successful based on an AIC diference of 5 between the LM and the null model.
