...
\begin{figure}
\includegraphics[width=.48\textwidth{}]{{patient_***REMOVED***}.pdf}
\caption{Patient 1.
...
\label{fig:pat1}
\sublabel{fig:pat1vl}
\sublabel{fig:pat1tree}
\sublabel{fig:pat1distvtime}
\sublabel{fig:pat1hist}
\end{figure}

The blind-dating method was applied to the HIV sequences of Patient 1.
...
\label{fig:pat2}
\sublabel{fig:pat2vl}
\sublabel{fig:pat2tree}
\sublabel{fig:pat2distvtime}
\sublabel{fig:pat2hist}
\end{figure}
...
The first LM, which used the sequences collected while the patient was on dual therapy, had an Akaike Information Criterion (AIC) of -642 compared to a null model AIC of -628.
The RMSE of the training data on the second LM was 1420 days.
...
We then attempted to recover the collection dates of the sequences, censoring 2--13 timepoints worth of sequences.
For each number of time points censored, we ran 50 trials censored different time points; except when we censored 2 timepoints we used all 14 possibilities.
See \cref{fig:validationrna}.

\begin{figure}
\includegraphics[width=.48\textwidth{}]{{get_rna}}
...
\sublabel{fig:valrnafit}
\sublabel{fig:valrnarmse}
\end{figure}
...
From this we generated different data sets with 2--13 time points with training RNA sequences (50 data sets for each number of time points) and all 14 possible data sets with 13 time points of training RNA sequences.
See \cref{fig:validationdna}.

\begin{figure}
\includegraphics[width=.48\textwidth{}]{sensitivity}
...
\sublabel{fig:valdnafit}
\sublabel{fig:valdnarmse}
\end{figure}
...
We checked for recombination with RDP \cite{RPD} using their full exploratory recombination scan.
