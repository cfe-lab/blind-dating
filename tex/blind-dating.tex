...
%We also required that at least 1 RNA time point fell between 2 DNA time points in each indiviudal
...
We evaluated the latency of the censored sequences using a nonparameteric binomial test.
...
See Figure \ref{fig:densityancre} for a density plot of the RMSDs.
...
See Figures \ref{fig:densitylanl1} and \ref{fig:densitylanl2} for density plots of the RMSDs.
...
\begin{figure}[ht]
	...
	\begin{subfigure}[ht]{8cm}
		...
		\caption{Density of the scaled difference of the \emph{plasma} data set with a solid line representingt he density of the scaled difference of the first set of simulated data set with latency.}
		\label{fig:densitylanl1}
		\end{subfigure}
	\begin{subfigure}[ht]{8cm}
		\centering
	...
	\end{subfigure}
	\caption[Differencde Density]{The density of the scaled difference. The solid lines represent the density in the simulated data.}
	\label{fig:density}
\end{figure}
...
\begin{figure}[ht]
	...
	The solid black line is the quadratric regression with the mean of the parameters from the mixed effects model.  %The dotted lines are the 95\% confidence interval of the parameters of the quadratric regression.
	}
	\label{fig:glm}
\end{figure}
\end{comment}
