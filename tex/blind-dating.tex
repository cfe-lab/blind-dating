...
We validated our method by attaempting to recover the collection dates of plasma-derivied RNA sequences.
Then we applied our method to patient data from a patient with both longitudinal plasma-derived RNA sequences while treatment-naive and PBMC-derived DNA sequences after the patient recieved anitretroviral theray for 6--10 years.
We compared results of using single-genome amplification of the NEF region and deep sequencing of the V3 region.
