...
%% recalculate
From these results, we manually selected 25 individuals that had well-characterized partial {\em env} sequences and plasma samples from at least 2 RNA time points and 4 DNA time points (Table \ref{tab:patients}). 
