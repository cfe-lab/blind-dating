...
The residuals of the {GLME model} without using the transformation were not normally distributed, so we will only consider the GLME model using the transformed differences, $\hat{d}_s$.
