...
Our method is as follows: From aligned HIV sequences from a single individual sampled over multiple time points, a maximum-likelihood phylogeny is reconstructed.
...
To validate the method, we generated simulated HIV phylogenies and used RAxML to produce simulated HIV sequences.
We then applied our method to simulated sequences with and without latency and to HIV RNA datasets.
Next we simulated latent lineages by shortening tip lengths and applied the same methodology as above.
