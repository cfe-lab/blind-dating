...
%\subsection * {Data Collection  / Sequence Generation}
...
In our experiments, our reconstructed phylogenies from the simulated and real data sets were maximum likelihood phylogenies reconstructed using RAxML 8.2.4 \citep{Raxml14} with the GTR model.
...
The expected amount of evolution was taken to be the dependent variable and the sampling dates of the data were taken as the independent variables. 
...
Latent lineages are more likely than non-latent lineages to appear later in time than the line of the linear regression from the previous section, see Figure \ref{fig:latenttree}.
