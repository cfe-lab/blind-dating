...
pat_id_info=${SLURM_JOB_NAME}.cens
pat_id=${SLURM_JOB_NAME}-rms.cens
...
echo "Rooting"
Rscript ${src}/root.tree.R trees/${pat_id_tree}.nwk info/${pat_id_info}.csv trees.rooted/${pat_id}.rtt.nwk 1 0
echo "Regressing"
Rscript ${src}/regression.R --tree=trees.rooted/${pat_id}.rtt.nwk --info=info/${pat_id_info}.csv --patid=${pat_id}
echo "Plotting"
