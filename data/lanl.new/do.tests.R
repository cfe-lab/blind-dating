...
do.all <- function(i) {
	...
	print(fisher.test(matrix(c(sum(latent.data$Type == 'PBMC'), sum(good.data$Type == 'PBMC') + sum(fast.data$Type == 'PBMC'), sum(latent.data$Type == 'PLASMA'), sum(good.data$Type == 'PLASMA') + sum(fast.data$Type == 'PLASMA')), ncol=2)))
	cat("Slow v Fast\n")
...
cat("DNA v RNA contigency\n")
fisher.test(matrix(c(sum(skew.latent.data$Type == 'PBMC'), sum(skew.good.data$Type == 'PBMC') + sum(skew.fast.data$Type == 'PBMC'), sum(skew.latent.data$Type == 'PLASMA'), sum(skew.good.data$Type == 'PLASMA') + sum(skew.fast.data$Type == 'PLASMA')), ncol=2))
cat("Slow v Fast\n")
...
cat("DNA v RNA contigency\n")
fisher.test(matrix(c(sum(all.latent.data$Type == 'PBMC'), sum(all.good.data$Type == 'PBMC') + sum(all.fast.data$Type == 'PBMC'), sum(all.latent.data$Type == 'PLASMA'), sum(all.good.data$Type == 'PLASMA') + sum(all.fast.data$Type == 'PLASMA')), ncol=2))
cat("Slow v Fast\n")
