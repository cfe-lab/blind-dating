...
SetDialogPrompt ("Please specify an output file:");
fprintf(PROMPT_FOR_FILE, ancestral_filter)

// the root sequence is always the first one in the file

//for (i=0; i < 
//GetDataInfo (root_ancestor, ancestral_filter, i);

//fprintf (stdout, "Inferred the `SELECTION_STRINGS`", i, " sequence as \n", root_ancestor, "\n");