...
op <- add_option(op, "--colourscheme", type='character', default=NA)
op <- add_option(op, "--viridis", type='logical', action='store_true')
op <- add_option(op, "--rainbow", type='logical', action='store_true')
op <- add_option(op, "--black", type='logical', action='store_true')
...
op <- add_option(op, "--estyearby", type='numeric', default=NA)
